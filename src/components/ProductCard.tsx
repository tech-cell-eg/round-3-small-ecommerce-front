  ...
  return (
    <Link to={`/product/${product.id}`}>
      <div className="relative min-w-[300px] h-[363px] rounded-2xl bg-[#F7F7F8] mx-2">
        ...
        <div className="size-[50px] absolute bottom-0 right-0 bg-custom-yellow-50 rounded-full flex items-center justify-center hover:scale-150 transition-all ease-in-out duration-150">
